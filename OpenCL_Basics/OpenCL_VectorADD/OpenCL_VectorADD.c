...
int main(){
	...
	for(i=0;i<LIST_SIZE;i++){
		A[i] = i; //if list size is very large
	}
	...
	cl_mem b_mem = clCreateBuffer(context,CL_MEM_READ_ONLY,LIST_SIZE * sizeof(int), NULL,&status);
	...
	status = clEnqueueWriteBuffer(cq,b_mem,CL_TRUE,0,LIST_SIZE*sizeof(int),B,0,NULL,NULL);
